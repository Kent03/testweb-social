...
const Toast = ({msg, handleShow, bgColor}) =>{
    ...
    return (
         <div className="toast" style={{position:'fixed',padding:'5px',borderRadius:'5px', backgroundColor:`${bgColor}` , color:'rgb(238 238 244)' , top:'5px', right:'5px', zIndex:'50', minWidth:'230px'}}>
